                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <button type="button" class="btn btn-success" style="margin-bottom: 20px;"
                            onclick="javascript:window.location.href='themkhachhang.php'">Thêm khách hàng</button>
                    </div>
                </div>
                    ...
                    <table class="table">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="col-equal">Mật khẩu</th>
                        ...
                        <tbody>
                            <?php
                                ...
                                try {
                                    ...
                                    $countSql = "SELECT COUNT(*) FROM nguoi_dung WHERE vai_tro = 3";
                                    ...
                                    $sql = "SELECT * FROM nguoi_dung WHERE vai_tro = 3 LIMIT :offset, :limit";
                                    ...
                                    if ($results) {
                                        ...
                                        foreach ($results as $row) {
                                            ...
                                            echo "<td class='col-equal'>" . htmlspecialchars($row["mat_khau_hash"]) . "</td>";
                                            echo "<td class='col-equal'>" . htmlspecialchars($row["so_dien_thoai"]) . "</td>";
                                            echo "<td class='col-equal'>
                                                    <a href='edit_khachhang.php?id=" . htmlspecialchars($row["id"]) . "' class='btn btn-warning btn-sm'>Sửa</a>
                                                    <a href='del_khachhang.php?id=" . htmlspecialchars($row["id"]) . "' class='btn btn-danger btn-sm' onclick=\"return confirm('Bạn có chắc muốn xóa?');\">Xóa</a>
                                                </td>";
                                            echo "</tr>";
                                        }
                                    } else {
                            ...
                            <tr>
                                <td colspan="7" class="pagination">
                                    <?php
                                        ...
                                        $stmtCount = $conn->query("SELECT COUNT(*) FROM nguoi_dung WHERE vai_tro = 3");
